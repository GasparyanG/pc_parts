...
use App\Services\Crawling\Specifications\PCPartPicker\PartPersisting\GPUPersistingImplementer;
...
class GPUScraper extends AbstractScraping
{
    static $collectionUrl = "https://pcpartpicker.com/products/video-card/fetch/";
    static $enumNamespace = "App\Services\Crawling\Specifications\PCPartPicker\ExtractionEnum\GPUExtractionEnum";
    ...
    public function crawl(): void
    {
        ...
        for ($i=0; $i<count($collection); ++$i) {
            try {
                ...
                $gpu = new GPU($data_from_spec_page);

                // persisting
                $gpuPersistingImplementer = new GPUPersistingImplementer($gpu);
