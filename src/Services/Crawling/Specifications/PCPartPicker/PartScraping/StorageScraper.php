...
class StorageScraper extends AbstractScraping
{
    ...
    static $enumNamespace = "App\Services\Crawling\Specifications\PCPartPicker\ExtractionEnum\StorageExtractionEnum";
    ...
    protected $collection_page_headers = [
        ...
        "referer" => "https://pcpartpicker.com/products/internal-hard-drive/",
