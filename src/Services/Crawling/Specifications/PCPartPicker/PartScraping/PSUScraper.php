...
class PSUScraper extends AbstractScraping
{
    static $collectionUrl = "https://pcpartpicker.com/products/power-supply/fetch/";
    static $XPaths = [
    ...
    static $enumNamespace = "App\Services\Crawling\Specifications\PCPartPicker\ExtractionEnum\PSUExtractionEnum";
    ...
    protected $collection_page_headers = [
        ...
        "referer" => "https://pcpartpicker.com/products/power-supply/",
